...
- [<i class="fa-solid fa-diagram-project"></i> Projeto](/Projeto/Projeto.md)

- **Modelagem**
  - [<i class="fa-solid fa-pen-ruler"></i> 2. Desenho de Software](/Modelagem/2.Modelagem.md)
    - [<i class="fa-solid fa-cube"></i> 2.1. UML Estática](/Modelagem/2.1.ModelagemEstatica.md)
    - [<i class="fa-solid fa-bolt"></i> 2.2. UML Dinâmica](/Modelagem/2.2.ModelagemDinamica.md)
