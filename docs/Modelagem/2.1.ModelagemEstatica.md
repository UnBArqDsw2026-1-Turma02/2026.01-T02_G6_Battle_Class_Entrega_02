...
| Lucas Oliveira | ![Lucas — Classes (autor + resposta à Ana)](../assets/comprovatorios/Lucas/ComentarioDiagramaDeClasse.png) |
...
| Otávio         | ![Otávio — Componentes](../assets/comprovatorios/Otavio/ComprobatorioDiagramaDeComponentes.png)             |
...
| Lucas Oliveira | ![Lucas — Implantação](../assets/comprovatorios/Lucas/ComentarioDiagramaDeImplantacao.png)                            |
| Otávio         | ![Otávio — Implantação (histórico de edição)](../assets/comprovatorios/Otavio/ComprobatorioDiagramaDeImplantacao.png) |
...
| 1.1 | 24/04/2026 | Diagrama de Classes publicado por Lucas Oliveira (visão geral + 4 quadrantes ampliados) | Lucas Oliveira | Ana Elisa, Gabriela |
